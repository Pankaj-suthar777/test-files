            ...
            <div className="px-6">
              <div className="flex flex-wrap justify-center">
                ...
                <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                  ...
                  >
                    <Button
                      variant="contained"
                      className="bg-pink-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150 flex justify-center items-center gap-2 text"
                      type="button"
              ...
              <div className="md:mt-10  mt-5 py-5 md:py-10 border-t border-blueGray-200 text-center">
                ...
                <div className="flex justify-center w-full">
                  {/* <div className="sm:w-[80%] md:mt-20 mt-10 w-full"> */}
